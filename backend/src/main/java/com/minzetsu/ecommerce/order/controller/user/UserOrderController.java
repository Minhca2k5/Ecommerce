...
public class UserOrderController {
    ...
    @Operation(summary = "Lấy danh sách đơn hàng của người dùng hiện tại", description = "Trả về danh sách tất cả các đơn hàng mà người dùng hiện tại đã đặt.")
    @GetMapping
    ...
    @Operation(summary = "Lấy thông tin chi tiết đơn hàng theo ID", description = "Trả về thông tin đầy đủ của đơn hàng (bao gồm sản phẩm, thanh toán, vận chuyển) của người dùng hiện tại.")
    @GetMapping("/{orderId}")
    ...
    @Operation(summary = "Lấy số tiền giảm giá khi áp dụng voucher cho đơn hàng mới", description = "Tính toán và trả về số tiền giảm giá khi người dùng hiện tại áp dụng một voucher cụ thể cho đơn hàng mới.")
    ...
    @Operation(summary = "Tạo đơn hàng mới", description = "Người dùng hiện tại tạo một đơn hàng mới dựa trên thông tin trong yêu cầu (giỏ hàng, địa chỉ, phương thức thanh toán, v.v.).")
    @PostMapping
