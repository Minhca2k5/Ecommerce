...
public class UserAddressController {
    ...
    @Operation(
            ...
            description = "Trả về tất cả các địa chỉ đã được lưu của người dùng hiện tại."
    )
    @GetMapping
    ...
    @Operation(
            ...
            description = "Trả về địa chỉ được đánh dấu là mặc định của người dùng hiện tại."
    )
    @GetMapping("/default")
    ...
    @Operation(
            ...
            description = "Thêm địa chỉ mới cho người dùng hiện tại. Có thể đặt làm mặc định nếu cần."
    )
    @PostMapping
    ...
    @Operation(
            summary = "Cập nhật địa chỉ của tôi",
            description = "Cập nhật thông tin địa chỉ cụ thể của người dùng hiện tại."
    )
    ...
    @Operation(
            summary = "Xóa địa chỉ của tôi",
            description = "Xóa một địa chỉ cụ thể thuộc người dùng hiện tại."
    )
    ...
    @Operation(
            ...
            description = "Đặt một địa chỉ cụ thể của người dùng làm địa chỉ mặc định."
    )
    ...
    @Operation(
            summary = "Lấy địa chỉ của tôi theo ID",
            description = "Trả về chi tiết của một địa chỉ cụ thể thuộc người dùng hiện tại."
    )
