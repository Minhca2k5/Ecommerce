...
public class ProductController {
    ...
    @Operation(
            summary = "Lấy danh sách sản phẩm đánh giá cao",
            description = "Trả về danh sách các sản phẩm có đánh giá cao nhất trong một khoảng thời gian nhất định."
    )
    ...
    @Operation(
            summary = "Lấy danh sách sản phẩm được yêu thích nhiều nhất",
            description = "Trả về danh sách các sản phẩm được thêm vào danh sách yêu thích nhiều nhất trong một khoảng thời gian nhất định."
    )
    ...
    @Operation(
            summary = "Lấy danh sách sản phẩm được xem nhiều nhất",
            description = "Trả về danh sách các sản phẩm được xem nhiều nhất trong một khoảng thời gian nhất định."
    )
    ...
    @Operation(
            ...
            description = "Trả về danh sách các sản phẩm bán chạy nhất trong một khoảng thời gian nhất định."
    )
