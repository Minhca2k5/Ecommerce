...
public class UserReviewController {
    ...
    @Operation(
            summary = "Xem tất cả đánh giá của tôi",
            description = "Trả về danh sách toàn bộ các đánh giá mà người dùng hiện tại đã viết."
    )
    @GetMapping
    ...
    @Operation(
            ...
            description = "Người dùng có thể viết một đánh giá mới cho sản phẩm mà họ đã mua."
    )
    @PostMapping
    ...
    @Operation(
            ...
            description = "Cập nhật điểm rating cho đánh giá cụ thể thuộc về người dùng hiện tại."
    )
    ...
    @Operation(
            ...
            description = "Cập nhật phần bình luận (comment) trong đánh giá của người dùng hiện tại."
    )
    ...
    @Operation(
            ...
            description = "Xóa đánh giá cụ thể của người dùng hiện tại theo ID."
    )
