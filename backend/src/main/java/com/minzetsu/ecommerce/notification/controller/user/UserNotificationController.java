...
public class UserNotificationController {
    ...
    @Operation(summary = "Lấy danh sách thông báo của người dùng hiện tại", description = "Trả về tất cả các thông báo liên quan đến người dùng hiện tại (không phân trang).")
    ...
    @Operation(summary = "Tạo thông báo cho người dùng hiện tại", description = "Tạo một thông báo mới liên quan đến người dùng hiện tại.")
    @ApiResponse(responseCode = "200", description = "Thành công - Trả về thông báo đã được tạo")
    @PostMapping
    public ResponseEntity<NotificationResponse> createNotificationForCurrentUser(
            @Valid @RequestBody NotificationCreateRequest request) {
        Long userId = getCurrentUserId();
        return ResponseEntity.ok().body(notificationService.createNotificationResponse(request, userId));
    }

    @Operation(summary = "Cập nhật trạng thái đã đọc của thông báo", description = "Cập nhật trạng thái đã đọc/chưa đọc của một thông báo cụ thể.")
    ...
    @Operation(summary = "Cập nhật trạng thái ẩn của thông báo", description = "Cập nhật trạng thái ẩn/hiện của một thông báo cụ thể.")
    ...
    @Operation(summary = "Cập nhật trạng thái đã đọc/ẩn cho tất cả thông báo", description = "Cập nhật trạng thái đã đọc hoặc ẩn cho tất cả thông báo của người dùng hiện tại.")
