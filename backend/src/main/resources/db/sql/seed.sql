...
INSERT INTO orders (id, user_id, address_id_snapshot, total_amount, currency, status) VALUES
(1, 2, 2, 10890000, 'VND', 'PAID'),
(2, 3, 3, 390000, 'VND', 'PENDING'),
(3, 4, 4, 20740000, 'VND', 'SHIPPED'),
(4, 5, 5, 450000, 'VND', 'CANCELLED'),
(5, 6, 6, 3990000, 'VND', 'PENDING'),
(6, 7, 7, 1299000, 'VND', 'PAID'),
(7, 8, 8, 14990000, 'VND', 'PAID'),
(8, 9, 9, 690000, 'VND', 'SHIPPED'),
(9, 10, 10, 450000, 'VND', 'PAID'),
(10, 11, 11, 590000, 'VND', 'PENDING'),
(11, 12, 12, 520000, 'VND', 'PAID'),
(12, 13, 13, 7490000, 'VND', 'PAID'),
(13, 14, 14, 1290000, 'VND', 'CANCELLED'),
(14, 15, 15, 180000, 'VND', 'PAID'),
(15, 16, 16, 1590000, 'VND', 'SHIPPED'),
(16, 17, 17, 320000, 'VND', 'PAID'),
(17, 18, 18, 12990000, 'VND', 'PENDING'),
(18, 19, 19, 690000, 'VND', 'PAID'),
(19, 20, 20, 2490000, 'VND', 'PAID'),
(20, 21, 21, 10990000, 'VND', 'PENDING'),
(21, 22, 22, 490000, 'VND', 'PAID'),
(22, 23, 23, 210000, 'VND', 'PAID'),
(23, 24, 24, 690000, 'VND', 'SHIPPED'),
(24, 25, 25, 2490000, 'VND', 'PAID'),
(25, 2, 2, 390000, 'VND', 'PENDING');
