...
| **Order** | Order placement, Order Items, Status management | 🚧 Structure Ready |
| **Cart** | Add to cart, Update quantity, Remove item | 🚧 Structure Ready |
| **Inventory** | Warehouses, Stock management | 🚧 Structure Ready |
| **Promotion** | Vouchers, Banners | 🚧 Structure Ready |
| **Activity** | Wishlist, Recent Views, Search Logs | 🚧 Structure Ready |
...
## 📝 Next Steps (Phase 2)
- [ ] Implement complex business logic for Orders (Inventory check, Transaction).
- [ ] Integrate Payment Gateways (VNPay/Momo).
- [ ] Advanced Search (Elasticsearch/Specification).
